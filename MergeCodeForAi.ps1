...
Write-Host "Začínam vyhľadávať a spájať .cs súbory (ignorujem zložky bin a obj)..." -ForegroundColor Cyan

# Počítadlo spracovaných súborov
$counter = 0

# Získanie všetkých .cs súborov rekurzívne s vylúčením bin a obj
Get-ChildItem -Filter *.cs -Recurse | Where-Object { $_.FullName -notmatch '[\\/]bin[\\/]' -and $_.FullName -notmatch '[\\/]obj[\\/]' } | ForEach-Object {

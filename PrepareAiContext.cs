...
// Názov výstupného súboru (vytvorí sa pri .sln súbore)
...
// 1. Zozbieranie súborov z hlavného adresára
...
// 2. Zozbieranie súborov z podadresárov
...
// 3. Spájanie súborov a zápis do výsledného textového súboru
...
Console.WriteLine();
Console.WriteLine("=====================================================");
Console.WriteLine($"HOTOVO! Súbor bol úspešne vygenerovaný ako: {outputFile}");